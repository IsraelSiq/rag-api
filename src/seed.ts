...
const skills: SkillRow[] = [
  ...
  { id: 'lk_concentration', name: 'Berserk Pitfou', max_level: 5, type: 'passive', description: 'Aumenta ATK com espada de duas mãos baseado em STR.', job_id: 'lord-knight' },
...
async function seed() {
  console.log(`\n🌱 Iniciando seed de ${skills.length} skills...\n`)
  ...
  console.log(`✅ Seed concluído! ${count ?? skills.length} skills inseridas/atualizadas.`)
}
